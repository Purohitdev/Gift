    ...
    <main className="min-h-screen py-12">
      <div className="container px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-muted-foreground mb-8">Last updated: May 1, 2023</p>
          ...
          <div className="prose prose-sm sm:prose max-w-none">
            ...
            <p>
              ...
              sign up for our newsletter, or contact us. This may include:
            </p>
            <ul>
              <li>
                Personal information such as your name, email address, postal address, phone number, and payment
                information
              </li>
              <li>Order information including products purchased, delivery details, and special instructions</li>
            ...
            <ul>
              <li>
                Service providers who perform services on our behalf (such as payment processors and shipping companies)
              </li>
            ...
            <p>
              ...
              <br />
              Address: 123 Gift Street, Craftville, CV 12345, United States
            </p>
          </div>
        </div>
      </div>
